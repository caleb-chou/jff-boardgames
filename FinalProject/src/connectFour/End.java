...
public class End extends JFrame {
    ...
    private void initializeUI(){
        ...
        Color c;
        switch(winner){
            case Game.RED_WIN: c = Color.RED; break;
            case Game.YELLOW_WIN: c = Color.YELLOW; break;
            case Game.DRAW: c = Color.WHITE; break;
        ...
        switch(winner){
            case Game.RED_WIN: winnerLabel.setText("RED WINS!"); break;
            case Game.YELLOW_WIN: winnerLabel.setText("YELLOW WINS!"); break;
